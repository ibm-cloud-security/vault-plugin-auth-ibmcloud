...
func pathConfigRotateRoot(b *ibmCloudAuthBackend) *framework.Path {
...
func (b *ibmCloudAuthBackend) pathConfigRotateRootWrite(ctx context.Context, req *logical.Request, data *framework.FieldData) (*logical.Response, error) {
	...
	keyDescription := "Generated by Vault's auth method for IBM Cloud during root key rotation."
